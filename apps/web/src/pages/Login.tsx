...
export function Login({ onSubmit, busy, error }: { onSubmit: (password: string) => void; busy: boolean; error?: string }) {
  ...
  return <main className="login-page">
    ...
    <Panel className="login-panel"><div className="brand"><span className="brand__mark">☾</span><span>鸦钟夜话</span></div><p className="eyebrow">受邀者入口</p><h1>钟楼只为受邀者敲响</h1><p>输入主人提供的访问口令。进入后，所有人仍需使用同一个六位房间邀请码。</p>
